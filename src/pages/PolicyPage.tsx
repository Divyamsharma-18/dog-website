...
const policies: Record<string, { title: string; content: string[] }> = {
  "refund-policy": {
    title: "Refund Policy",
    content: [
      "At Happy Paws Pantry, we stand behind the quality of our products. If you're not completely satisfied, we're here to help.",
  ...
  terms: {
    ...
    content: [
      "By using the Happy Paws Pantry website and purchasing our products, you agree to these terms and conditions.",
      "Products: All products are intended for dog consumption only. Follow feeding guidelines on packaging. Happy Paws Pantry is not responsible for misuse of products.",
      ...
      "Intellectual Property: All content on this site including text, images, and logos is the property of Happy Paws Pantry and may not be used without permission.",
    ],
  },
  "shipping-policy": {
    title: "Shipping Policy",
    content: [
      "Happy Paws Pantry ships to Delhi and nearby cities.",
  ...
  "privacy-policy": {
    ...
    content: [
      "Happy Paws Pantry respects your privacy and is committed to protecting your personal information.",
